            ...
            requestElement.innerHTML = `
                <div class="request-info">
                    ...
                    <div class="additional-info" style="display: none;">
                        ...
                        <div class="request-area"><strong>Area:</strong> ${request.area}</div>
                        <div class="request-location"><strong>Governorate:</strong> ${request.location}</div>
                        <div class="request-government"><strong>Government:</strong> ${request.government}</div>
                        <a href="../location/location.html"><button class="location">Location</button><a>
                        </div>
                </div>
